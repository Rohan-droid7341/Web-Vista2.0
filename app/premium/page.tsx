            ...
            <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    You can upgrade or downgrade your plan at any time from your account settings. Changes to your plan
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We don't currently offer a free trial, but our Basic plan is free forever and gives you access to
                    many features to get started.
                  </p>
                </div>
              </div>
            </div>
