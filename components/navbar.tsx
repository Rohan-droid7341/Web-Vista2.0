...
export default function Navbar() {
      ...
      if (storedUserData) {
        try {
          ...
          if (parsedData && parsedData.email) {
            // Check for existence of essential data
            setIsLoggedIn(true);
          ...
          console.error(
            "Navbar: Failed to parse user data from storage",
            error
          );
  ...
  const navLinks = [
    /* ... (keep your navLinks array) ... */ { href: "/", label: "Home" },
    { href: "/subjects", label: "Subjects" },
    { href: "/events", label: "Events" },
    { href: "/study-materials", label: "Study Material" },
